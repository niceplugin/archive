...
- **선언적 랜더링**: Vue는 표준 HTML을 템플릿 구문으로 확장하여 JavaScript 상태를 기반으로 화면에 출력될 HTML을 작성할 수 있습니다.
...
대부분의 빌드 툴 지원 Vue 프로젝트에서 **싱글 파일 컴포넌트**(Single-File Component: **SFC**, `*.vue` 파일이라고도 함)라는 HTML과 유사한 파일 형식을 사용하여 Vue 컴포넌트를 작성합니다.
...
옵션 API를 사용하여 `data`, `methods` 및 `mounted`와 같은 옵션의 개체를 사용하여 컴포넌트의 로직를 정의합니다.
...
[온라인 연습장으로 실행하기](https://sfc.vuejs.org/#)
...
[온라인 연습장으로 실행하기](https://sfc.vuejs.org/#)
...
또한 반응성 세부 사항을 추상화하고 옵션 그룹을 통해 코드 구조를 실행하여 초보자에게 더 친숙합니다.

컴포지션 API는 함수 범위에서 직접 반응성 변수를 선언하고 복잡성을 처리하기 위해 여러 함수의 상태를 함께 구성하는데 중점을 둡니다.
보다 자유로운 형식이며 Vue에서 반응성이 효과적으로 사용되는 방식에 대한 이해가 필요합니다.
