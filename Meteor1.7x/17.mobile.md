...
Cordova 앱은 HTML, CSS 및 JavaScript를 사용하여 작성된 웹 앱으로 독립적인 모바일 앱으로 실행되는 것이 아닌 앱 내의 [웹 뷰](#12-실행환경)에서 실행됩니다.
...
또한 Cordova는 [플러그인 아키텍쳐](#cordova-플러그인의-기본-기능)를 통해 기기의 기본적인 기능에 대한 액세스를 합니다.
...
### 9.3.1 Crosswalk를 사용하여 Play Store에 앱 제출하기
